    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttnadd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String getPlace = editTextEmail.getText().toString();

                if (mydb.insertContact(getName, getPhone, getEmail,getPlace)) {
                    Log.v("georgeLog", "Successfully inserted record to db");
                    Toast.makeText(getApplicationContext(),
                            "Inserted:" + getName + ", " + getPhone + "," + getEmail+ "," +getPlace, Toast.LENGTH_SHORT).show();
                } else
        ...
        bttnshow1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (getData.moveToNext()) {// data?
                    ...
                    Toast.makeText(getApplicationContext(),
                            "rec: " + dName + ", " + dPhone + ", " + dEmail+ ", " +dPlace, Toast.LENGTH_LONG).show();
                }
                else
                    Toast.makeText(getApplicationContext(),
