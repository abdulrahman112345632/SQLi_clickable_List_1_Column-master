...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table contacts " +
                        "(id integer primary key, name text,phone text,email text,place text)"//, street text,place text)"
        );
    }
    ...
    public boolean insertContact  (String name, String phone, String email,String place){//, String street,String place)
